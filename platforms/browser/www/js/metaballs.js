paper._execute = function(__$__,project,Point,Group,Path,onMouseMove) {// Ported from original Metaball script by SATO Hiroyuki
...
function generateConnections(paths) {
	...
	for (var i = 0, l = paths.length; i < l; i++) {
		for (var j = __$__(i, "-" , 1); j >= 0; j--) {
			var path = metaball(paths[i], paths[j], 0.5, handle_len_rate, 160);
			if (path) {
